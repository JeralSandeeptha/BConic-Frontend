...
import { SigninPageProps } from '../../types/page';
import handleRegister from '../../api/user-service/creareUser';
    ...
    <div className='test register-page'>
      <div className="test register-page-left">
        ...
        <div className='test bottom-content'>
          ...
          <QuoteText quote='Create a order and' />
          <QuoteText quote='Live tracking of couriers.' />
        </div>
      </div>
      <div className="test register-page-right">
        ...
        <div className="test register-page-right-inner">
          ...
          <AuthHeader title="New To Courier ?" />
