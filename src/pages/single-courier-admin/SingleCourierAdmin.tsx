    ...
    <div className='single-courier test'>
      ...
      <div className="test single-courier-content">
        ...
        <div className="test middle">
          <div className="test middle-left">
            ...
            <div className="test info-container">
              ...
              <h6 className="test info">{courier?.sender_address || 'Not Set'}</h6>
            </div>
            <div className="test info-container">
              <h6 className="test info-lable">Recepient Name:</h6>
              <h6 className="test info">{courier?.recipient_name || 'Not Set'}</h6>
            </div>
            <div className="test info-container">
              <h6 className="test info-lable">Recepient Address:</h6>
              <h6 className="test info">{courier?.recipient_address || 'Not Set'}</h6>
            </div>
            <div className="test info-container">
              <h6 className="test info-lable">Additional Info:</h6>
              <h6 className="test info">{courier?.additional_info || 'Not Set'}</h6>
            </div>
            <div className="test info-container">
        ...
        <div className="anim-container">
          {courier?.status === 'Order Placed' && <Lottie animationData={animationData1} className='test anim' />}
          {courier?.status === 'Delivered' && <Lottie animationData={animationData2} className='test anim' />}
          {courier?.status === 'Picked Up' && <Lottie animationData={animationData3} className='test anim' />}
          {courier?.status === 'CANCELLED' && <Lottie animationData={animationData4} className='test anim' />}
        </div>

        {
          courier?.status === 'Delivered' ? (
            ...
            <Section marginTop='20px'>
              <AuthButton title='Update Order' backgroundColor='black' textColor='white' onClick={handleUpdateOrder} />
            </Section>
          )
        }
